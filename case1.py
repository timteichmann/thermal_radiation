...
S.add_group("P3R", 4.5, 0.9)
S.add_group("P3L", 4.5, 0.9)
S.add_group("P4R", 4.5, 0.9)
S.add_group("P4L", 4.5, 0.9)
...
S.setup_case("in.case1", "geometry.surf", "photon.species", 1e16, 1e-2, 100, 1000)
